# IWantClipsStashDB — Stash plugin

Scrapes iWantClips and matches against local Stash. Adds a Scrape button to
scene pages.
...
```powershell
robocopy C:\Users\<you>\Documents\stash-plugins\plugins\IWantClipsStashDB `
    C:\Users\<you>\.stash\plugins\IWantClipsStashDB /MIR /XD __pycache__
```
